...
function selectCompletionScenePill(scenePill) {
    ...
    ourVideo.src = "https://genapi.sibowu.com/website/resources/videos/completion/ours/" + scene + ".mp4";
    ourVideo.load();
    compVideo.src = "https://genapi.sibowu.com/website/resources/videos/completion/2dgs/" + scene + ".mp4";
    compVideo.load();
}
...
function selectGenerationScenePill(scenePill) {
    ...
    artifactRgb.src = "https://genapi.sibowu.com/website/resources/videos/generation/" + scene + "/artifact_rgb.mp4";
    generatedRgb.src = "https://genapi.sibowu.com/website/resources/videos/generation/" + scene + "/generated_rgb.mp4";
    artifactDepth.src = "https://genapi.sibowu.com/website/resources/videos/generation/" + scene + "/artifact_depth.mp4";
    generatedDepth.src = "https://genapi.sibowu.com/website/resources/videos/generation/" + scene + "/generated_depth.mp4";
    artifactRgb.load();
    generatedRgb.load();
    artifactDepth.load();
    generatedDepth.load();
...
function selectSparseCompVideo(scenePill, viewNum) {
    ...
    ourVideo.src = "https://genapi.sibowu.com/website/resources/videos/sparse/ours/" + scene + ".mp4";
    ourVideo.load();
    compVideo.src = "https://genapi.sibowu.com/website/resources/videos/sparse/2dgs" + "/" + scene + ".mp4";
    compVideo.load();
...
function selectCompVideo(methodPill, scenePill) {
    ...
    ourVideo.src = "https://genapi.sibowu.com/website/resources/videos/dl3dv/ours/" + scene + ".mp4";
    ourVideo.load();
    compVideo.src = "https://genapi.sibowu.com/website/resources/videos/dl3dv/" + method + "/" + scene + ".mp4";
    compVideo.setAttribute("vc-caption", method.toUpperCase());
    compVideo.load();
    inputVideo.src = "https://genapi.sibowu.com/website/resources/videos/dl3dv/input/" + scene + ".mp4";
    inputVideo.load();
